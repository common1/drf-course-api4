## 01 Django REST Framework series - Setup and Models

[https://www.youtube.com/watch?v=6AEvlNgRPNc&list=PL-2EBeDYMIbTLulc9FSoAXhbmXpLq2l5t&index=1&t=14s]
...
## 02 Django REST Framework - Serializers & Response objects | Browsable API
...
http://localhost:8000/scoring/archers/?format=json
http://localhost:8000/scoring/archers/?format=api
```
...
## 09 Django REST Framework - APIView class
...
## 12 Django REST Framework - JWT Authentication with djangorestframework-simplejwt
...
## 13 Django REST Framework - Refresh Tokens & JWT Authentication
...
## 14 Django REST Framework - Updating & Deleting data
